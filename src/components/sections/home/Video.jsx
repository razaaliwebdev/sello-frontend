    ...
    return (
        <div className='bg-gray-100 w-full px-4 flex flex-col md:flex-row gap-10 md:px-16 py-8 md:py-24'>
            ...
            <div className="content">
                <h1 className="md:text-5xl text-3xl font-semibold max-w-4xl pb-5">Sell Your Car at the Best Price — Trusted Across Pakistan</h1>
                <p className="py-4 text-gray-600">
                   If you’re searching for a car for sale in Pakistan, or looking to list your own vehicle, our platform connects you with serious buyers nationwide.
                </p>
                <ul>
                    {
                        [
