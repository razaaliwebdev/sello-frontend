...
// This is a minimal fallback implementation in case TiptapEditor is imported elsewhere.
// The main implementation has been replaced by TinyMCE in TiptapEditor.jsx.
// However, since we overwrote that file, this file content is just conceptual 
// unless I accidentally broke something or imports are messy.
// Wait, I overwrote TiptapEditor.jsx with TinyMCE code. This file action is 
// actually creating the BlogCommentsSection.jsx, I just copy-pasted the wrong name mentally.
// Correcting...

import { useState } from 'react';
import { useSelector } from 'react-redux';
import { useGetBlogCommentsQuery, useCreateCommentMutation, useDeleteCommentMutation } from '../../../redux/services/api';
...
const BlogCommentsSection = ({ blogId }) => {
    ...
    const { data, isLoading } = useGetBlogCommentsQuery({ blogId, page, limit: 10 });
    ...
    return (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 md:p-8 mt-12" id="comments">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="flex justify-between items-center mt-2">
                                    ...
                                    >
                                        {isPosting ? 'Posting...' : <><FiSend /> Post Comment</>}
                                    </button>
                                </div>
                            </div>
                        </div>
                ...
                <div className="mt-8 flex justify-center gap-2">
                    ...
                    {Array.from({ length: pagination.pages }, (_, i) => i + 1).map(pageNum => (
                         <button
                            ...
                            className={`px-3 py-1 border rounded ${page === pageNum ? 'bg-primary-500 text-white border-primary-500' : 'hover:bg-gray-50'}`}
                        >
                            {pageNum}
                        </button>
                    ))}
