...
//                   <div
//                     key={carId}
//                     className="flex flex-col md:flex-row gap-7 p-4 border border-gray-100 rounded-lg hover:shadow-md transition-all duration-200 bg-white"
//                   >
//                     {/* Car Image */}
//                     <div className="md:w-48 h-36 bg-gray-50 rounded-lg overflow-hidden flex items-center justify-center relative">
//                       <LazyImage
//                         src={carImage}
...
//                             navigate(`/cars/${carId}`);
//                           }}
//                           className="text-white bg-primary-500 hover:bg-primary-600 flex items-center text-sm font-medium px-4 py-2 rounded-lg transition-colors"
//                         >
//                           View Details
