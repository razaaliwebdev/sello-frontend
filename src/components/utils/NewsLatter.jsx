      ...
      <div className="md:py-10 py-5">
        <form onSubmit={handleSubmit} className="field bg-white/20 h-12 sm:h-14 md:h-16 w-full max-w-md mx-auto px-3 sm:px-4 flex items-center justify-between gap-2 sm:gap-3 rounded-full">
          ...
          <button 
            type="submit"
            disabled={isLoading}
            className="bg-primary-500 text-xs sm:text-sm md:text-base py-1.5 px-3 sm:py-2 sm:px-4 md:py-3 md:px-6 rounded-full hover:opacity-90 transition-opacity whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed"
          >
