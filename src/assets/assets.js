  ...
  whyChooseUs: [
    {
      ...
      description:
        "Discover unbeatable deals tailored to your budget. Our finance experts work tirelessly to bring you the best value, every time.",
    },
    {
      image: why2,
      title: "Your Trusted Dealership Partner",
      description:
        "Built on honesty and reliability, we’ve earned the trust of thousands by delivering quality vehicles and exceptional customer care.",
    },
    {
      image: why3,
      title: "Clear, Honest Pricing",
      description:
        "What you see is what you pay — no hidden costs, no surprises. We believe in full transparency to help you shop with confidence.",
    },
    {
      image: why4,
      title: "Certified Service Expertise",
      description:
        "Our skilled technicians are committed to keeping your vehicle in top shape — from routine maintenance to advanced diagnostics.",
    },
  ],
};
